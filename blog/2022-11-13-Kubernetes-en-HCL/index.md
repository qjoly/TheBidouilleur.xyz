...
Ce n’est évidemment pas impossible, mais cela donne un fichier assez **illisible** et complexe à maintenir.
...
Dans un bon écosystème, nous déployons via Helm *(outil de template YAML similaire à Jinja2 adapté pour Kubernetes)*, voyons comment Hashicorp nous présente ça.
