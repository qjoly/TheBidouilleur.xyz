...
![Adding loki to grafana](https://i.imgur.com/G3tWx1r.png)
...
*If you are not comfortable with Jinja2 templates, you will find a "pure" version of the config [here](https://github.com/QJoly/promtail-ansible)*
...
![Explore tab of grafana](https://i.imgur.com/UNL2s6m.png)
...
![Grafana UI](https://i.imgur.com/MWFQCyl.png)

By validating our request (*button **show logs***)

![Logs by loki](https://i.imgur.com/RCpb5GI.png)
...
![Filter](https://i.imgur.com/HzTwmwW.png)
...
:::danger
This project is obsolete, it may be risky to use it in a sensitive environment.
:::
